...
export default function Footer() {
  return (
    <>
      ...
      <Mobile>
        <footer className="bg-footer mt-16 rounded-2xl text-primary-content px-[48px] py-[24px] flex flex-col gap-10">
          <div className="font-fredoka">
            <p className="text-[48px] font-semibold">Eventity.</p>
            <p className="text-[24px] font-medium">Ease of being together</p>
          </div>
          <div className="flex flex-col gap-[10px]">
            <div className="flex flex-col gap-[2px]">
              <div className="p-[8px] font-fredoka text-[24px] font-semibold">EVENTNITY</div>
              <Row>
                <RowList to="/register">Start For Free</RowList>
                <RowList to="/login">Login</RowList>
                <RowList to="/pricing">Pricing</RowList>
            ...
            <div className="flex flex-col gap-[2px]">
              <div className="p-[8px] font-fredoka text-[24px] font-semibold">FEATURES</div>
              <Row>
                <RowList>Payment Integration</RowList>
                <RowList>Newstlatter</RowList>
                <RowList>Email Marketing</RowList>
            ...
            <div className="flex flex-col gap-[2px]">
              <div className="p-[8px] font-fredoka text-[24px] font-semibold">COMPANY</div>
              <Row>
                <RowList>For Bussines</RowList>
                <RowList>About Us</RowList>
                <RowList>Blog</RowList>
          ...
          <div className="font-inter flex flex-col justify-between place-items-center">
...
function RowList({ children, to }) {
  return (
    <li className="text-md leading-4 font-medium hover:underline">
